...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color:#ffeca6;")
        ...
        self.logo.setStyleSheet("background-color:#ffeca6;\n"
"")
        self.logo.setText("")
        ...
        self.browse_box.setStyleSheet("background-color:#ffeca6;")
        ...
        self.build_parameters_box.setMinimumSize(QtCore.QSize(0, 200))
        self.build_parameters_box.setMaximumSize(QtCore.QSize(16777215, 200))
        self.build_parameters_box.setStyleSheet("background-color:#ffeca6;")
        ...
        self.threshold_parameters_box.setMinimumSize(QtCore.QSize(200, 0))
        ...
        self.threshold_adaptive_method_widget.setMinimumSize(QtCore.QSize(200, 50))
        ...
        self.threshold_type_widget.setMinimumSize(QtCore.QSize(200, 50))
        ...
        self.threshold_block_size_slider.setMaximum(15)
        self.threshold_block_size_slider.setProperty("value", 9)
        ...
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.bilateral_filter_box)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.bilateral_filter_distance_label = QtWidgets.QLabel(self.bilateral_filter_box)
        ...
        self.horizontalLayout_6.addWidget(self.bilateral_filter_distance_label)
        ...
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.bilateral_filter_distance_widget)
        ...
        self.verticalLayout_13.addWidget(self.bilateral_filter_distance_slider)
        self.horizontalLayout_6.addWidget(self.bilateral_filter_distance_widget)
        self.bilateral_filter_sigma_space_label = QtWidgets.QLabel(self.bilateral_filter_box)
        self.bilateral_filter_sigma_space_label.setMinimumSize(QtCore.QSize(5, 5))
        self.bilateral_filter_sigma_space_label.setObjectName("bilateral_filter_sigma_space_label")
        self.horizontalLayout_6.addWidget(self.bilateral_filter_sigma_space_label)
        self.bilateral_filter_sigma_space_widget = QtWidgets.QWidget(self.bilateral_filter_box)
        self.bilateral_filter_sigma_space_widget.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.bilateral_filter_sigma_space_slider.setProperty("value", 9)
        ...
        self.horizontalLayout_6.addWidget(self.bilateral_filter_sigma_space_widget)
        self.bilateral_filter_sigma_color_label = QtWidgets.QLabel(self.bilateral_filter_box)
        ...
        self.horizontalLayout_6.addWidget(self.bilateral_filter_sigma_color_label)
        ...
        self.bilateral_filter_sigma_color_slider.setProperty("value", 9)
        ...
        self.horizontalLayout_6.addWidget(self.bilateral_filter_sigma_color_widget)
        ...
        self.result_box.setMinimumSize(QtCore.QSize(0, 450))
        self.result_box.setMaximumSize(QtCore.QSize(16777215, 450))
        self.result_box.setStyleSheet("background-color:#ffeca6;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.threshold_block_size_label.setText(_translate("MainWindow", "BlockSize: 10"))
        self.threshold_distance_label_.setText(_translate("MainWindow", "Distance: 10"))
