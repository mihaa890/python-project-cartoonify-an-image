...
class LoadingScreen(QtWidgets.QFrame):
    """ Loading screen by a.s.akulov.
        Full decription see at:
                    https://github.com/a-s-akulov/py-loading-screen
                    or
                    https://pypi.org/project/py-loading-screen/
    ...
    def worker(self):
        ...
        while True:
            ...
            if 'exit_' in self.worker.__dict__:
                if self.worker.__dict__['exit_']:
                    self.exit = True
    ...
    async def worker_async(self):
        ...
        while True:
            ...
            # check for self.worker.exit:
            if 'exit_' in self.worker_async.__dict__:
                if self.worker_async.__dict__['exit_']:
                    self.exit = True
